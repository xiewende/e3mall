...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		//3、设置模板文件保存的目录
		configuration.setDirectoryForTemplateLoading(new File("C:\\Users\\lenovo\\Eeclipse-workspace\\e3-item-web\\src\\main\\webapp\\WEB-INF\\ftl"));
...
//		Template template = configuration.getTemplate("student.ftl");
		...
		Writer out = new FileWriter(new File("C:\\Users\\lenovo\\Eeclipse-workspace\\e3mall-freemarker\\hello.txt"));
